...
#| echo: false
#| output: true
sex_hcov_aic <- AIC(sex_f0, sex_f1, sex_f2, sex_f3, sex_f4, criterion = "AICc")
data.frame(
  modelname = row.names(sex_hcov_aic),
  sex_hcov_aic[, c("AICc", "dAICc", "AICcwt")]
)
```
...
#| echo: false
#| output: true
sex_group_aic <- AIC(sex_f0g, sex_f1g, sex_f2g, sex_f3g, sex_f4g, criterion = "AICc")
data.frame(
  modelname = row.names(sex_group_aic),
  sex_group_aic[, c("AICc", "dAICc", "AICcwt")]
)
```
\normalsize
